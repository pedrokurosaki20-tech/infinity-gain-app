...
export const tasks: Task[] = [
  {
    ...
    requirements: ["WhatsApp ativo", "Português fluente", "Atenção aos detalhes"],
    icon: Bot,
  ...
  },
  {
    slug: "rcs",
    title: "RCS",
    short: "Interaja com mensagens RCS e ganhe de R$0,30 a R$1,00 por tarefa concluída.",
    description: "Interaja com mensagens RCS e ganhe de R$0,30 a R$1,00 por tarefa concluída.",
  ...
  },
  {
    ...
    short: "Compartilhe conteúdos e receba de R$0,30 a R$1,00 por tarefa concluída.",
    description: "Compartilhe conteúdos e receba de R$0,30 a R$1,00 por tarefa concluída.",
    earnings: "R$ 0,30 – R$ 1,00 por tarefa",
    requirements: ["Ao menos 200 seguidores", "Perfil público", "Postar conforme briefing"],
    icon: Globe2,
  ...
  },
  {
    slug: "indique-ganhe",
    title: "Indique & Ganhe",
    short: "Ganhe R$0,50 por indicação válida + bônus extras conforme sua rede cresce.",
    description: "Ganhe R$0,50 por indicação válida + bônus extras conforme sua rede cresce.",
    earnings: "R$ 0,50 por indicação + bônus",
    requirements: ["Conta verificada", "Compartilhar link pessoal", "Amigo completar 1ª tarefa"],
    icon: UsersRound,
  ...
  },
  {
    ...
    requirements: ["Conta de e-mail ativa", "Acesso diário à plataforma", "Atenção aos detalhes"],
    icon: Mail,
    accent: "linear-gradient(135deg,#1e5eff,#ff66c4)",
  },
];
